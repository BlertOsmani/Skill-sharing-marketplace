...
function updateErrors(errors) {
  ...
  serverSideConfirmPasswordError.value = errors.confirmPassword
  ...
  serverSideFirstNameError.value = Array.isArray(errors.firstName)
    ? errors.firstName[0]
    : errors.firstName || "";
  serverSideLastNameError.value = Array.isArray(errors.lastName)
    ? errors.lastName[0]
    : errors.lastName || "";
}
  ...
  <form class="register-form" @submit.prevent="handleSubmit">
    <div class="register-form-fields-container">
      <div class="register-form-first-last-name-container">
        ...
        <span v-if="!firstNameValid" class="error-message"
      ...
      <div class="register-form-first-last-name-container">
        ...
        <span v-if="!lastNameValid" class="error-message"
    ...
    <div class="register-form-fields-container">
      ...
      <span v-if="!usernameValid" class="error-message"
        >Username is required and can contain letters, numbers, -, _ only.</span
      >
    ...
    <div class="register-form-fields-container">
      ...
      />
      <span v-if="!confirmPasswordValid" class="error-message"
        >Passwords do not match.</span
      >
      <span class="server-side-error">{{
