<template>
    <div class="card border-round-md surface-card w-custom-card flex flex-column">
      <Link :to="{path: '/course/details', query:{id: id}}" :highlight="false" class="align-items-stretch border-round-md surface-card flex-shrink-0 p-0 flex flex-column" @mouseover="showIcon" @mouseleave="hideIcon">
      <p class="hidden">{{ id }}</p>
